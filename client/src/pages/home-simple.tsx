      ...
      <section id="tokenomics" className="py-20 px-6 relative overflow-hidden bg-black">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-12">
            {/* Total Supply */}
            <div className="chainzoku-card premium-card p-6 text-center metaverse-pulse refined-shimmer sophisticated-border ">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="chainzoku-card premium-card refined-shimmer sophisticated-border p-8">
