        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="chainzoku-card p-8 text-center">
              ...
              <div className="bg-black border border-white/10 text-white text-sm font-black px-6 py-3 rounded-2xl shadow-lg shadow-white/20 font-['Orbitron'] uppercase chainzoku-glow">+8.2% 🔥</div>
            </div>
          </div>
