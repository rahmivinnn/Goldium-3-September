              ...
              <div 
                ...
                className={`p-4 rounded-lg border-2 transition-all backdrop-blur-sm ${
                  currentStage.name === stage.name 
                    ? 'border-white/20 bg-gradient-to-br from-black/80 to-gray-900/80 shadow-lg shadow-white/20' 
                ...
                <div className="text-center space-y-2">
                  <div className="w-12 h-12 mx-auto relative">
                    <div className={`absolute inset-0 rounded-full ${
                      currentStage.name === stage.name 
                        ? 'bg-gradient-to-br from-black/20 to-gray-900/20 animate-pulse' 
                  ...
                  <h4 className={`font-bold text-sm ${
                    currentStage.name === stage.name ? 'text-white' : 'text-gray-200'
                  }`}>{stage.name}</h4>
                  <p className={`text-xs ${
                    currentStage.name === stage.name ? 'text-white' : 'text-gray-400'
                  }`}>{stage.minDays}+ days</p>
                  <Badge 
                    variant="secondary" 
                    className={`text-xs ${
                      currentStage.name === stage.name 
                        ? 'bg-black/20 text-white border-white/20/30' 
