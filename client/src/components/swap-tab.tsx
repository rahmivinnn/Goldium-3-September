  ...
  const handleSwap = async () => {
    ...
    try {
      ...
      if (externalWallet.connected) {
        ...
        // Debug: Compare UI balance vs external wallet balance
        console.log(`🔍 Balance comparison:`);
        console.log(`  - UI Balance (fromBalance): ${fromBalance} ${fromToken}`);
        console.log(`  - External Wallet Balance: ${externalWallet.balance} SOL`);
