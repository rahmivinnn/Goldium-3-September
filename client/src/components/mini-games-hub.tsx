      ...
      <Tabs defaultValue="all-games" className="w-full">
        ...
        <TabsContent value="all-games" className="space-y-4">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {games.map((game) => (
              <Card key={game.id} className="bg-gray-900/20 border-gray-500/20 hover:border-gray-500/40 transition-all">
                <CardHeader>
      ...
      <Card className="bg-gray-900/20 border-gray-500/20">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-400">23,156</div>
