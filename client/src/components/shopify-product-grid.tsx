              ...
              <Card key={product.id} className="bg-galaxy-secondary border-galaxy-purple/20">
                <CardContent className="p-4 space-y-3">
                  ...
                  <div className="space-y-2">
                    <select className="w-full bg-galaxy-button border border-gray-500/30 rounded text-galaxy-bright text-xs p-2">
                    ...
                    <Button 
                      size="sm"
                      className="w-full bg-yellow-gradient hover:opacity-90 text-white"
