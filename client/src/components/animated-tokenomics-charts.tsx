            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className={`flex items-center text-sm ${
                  tokenomicsData.priceChange24h >= 0 ? 'text-yellow-400' : 'text-yellow-400'
                }`}>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="text-yellow-400">{formatCurrency(tokenomicsData.currentPrice * 1.15)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-yellow-200/70">24h Low</span>
                <span className="text-yellow-400">{formatCurrency(tokenomicsData.currentPrice * 0.85)}</span>
              </div>
              <div className="flex justify-between">
